...
* The Big Picture – Understanding I/O Runtime components	3
* Zoom In – What's Happening When Actions Are Invoked	4
* Let’s Talk Numbers – Understanding the System Settings	5
* I/O Events Integration	5
* Strategies for High Availability Applications	6
* CI/CD Pipeline – What Is Available	6
* Security Considerations	7
* The Future is Bright - Cloud Native Applications	7
 
## Programming Model
